...
class SemanticMemory:
    def __init__(
        ...
        from .maintenance import SemanticMaintenance

        self._maintenance = SemanticMaintenance(self)
        self._maintenance.run_startup(max_seconds=startup_maintenance_seconds)
